...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPortalAgency_API.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MyPortalAgency_API.Models.PageContentViewModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid>("PageViewModelId");
            ...
            modelBuilder.Entity("MyPortalAgency_API.Models.PageViewModel", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("58121566-f3f8-4bac-841a-e0996798da0a"), Description = "Shine Infosoft is a leading service provider with extensive experience in IT outsourcing services to enterprises across the globe. We are specialist in mobile application development, web development, software development, e-commerce, hybrid application development, SEO (Search Engine Optimization).", Title = "ABOUT SHINE INFOSOFT", Type = "AboutUs" }
                    );
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyPortalAgency_API.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyPortalAgency_API.Models.PageContentViewModel", b =>
                {
                    b.HasOne("MyPortalAgency_API.Models.PageViewModel", "PageViewModel")
                        .WithMany()
                        .HasForeignKey("PageViewModelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
