...
namespace MyPortalAgency_API.Migrations
{
    ...
    [Migration("20190308201506_Seed_ContactUs")]
    partial class Seed_ContactUs
    {
            ...
            modelBuilder.Entity("MyPortalAgency_API.Models.PageContentViewModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("44caf56f-1d64-4f43-b913-104b0f6564be"),
                            Description = "Acting ethically direct, honest and trustworthy through what we convey, matching our actions to our commitments and taking ownership of expected outcomes.",
                            Logo = "fa fa-bookmark",
                            More = "",
                            PageViewModelId = new Guid("605074af-a602-4afc-8e4d-a091cdf77ff9"),
                            Title = "Integrity ",
                            Type = "PillarsofOurSuccess"
                        },
                        new
                        {
                            Id = new Guid("c61fb2c6-221e-4c13-a634-30022cd77f25"),
                            Description = "Delivering industry’s best and innovative solutions by enabling customers to turn into high-performance business units by our team.",
                            Logo = "fa fa-users",
                            More = "",
                            PageViewModelId = new Guid("605074af-a602-4afc-8e4d-a091cdf77ff9"),
                        ...
                        new
                        {
                            Id = new Guid("7367b6f6-1b6b-4aff-8252-9c1344cb0eca"),
                            Description = "1234 Street Name, City Name, United States ",
                            Logo = "fas fa-map-marker-alt top-6",
                            More = "",
                            PageViewModelId = new Guid("ba9ffc21-8790-4fa5-927d-0e789ac0870c"),
                            Title = "Address",
                            Type = "OurOffice"
                        },
                        new
                        {
                            Id = new Guid("1e6654cc-02a4-4559-b325-c1ecf6bd771d"),
                        ...
                        new
                        {
                            Id = new Guid("b2c9226a-09da-4961-a6a8-ab8c3b97a1ea"),
                        ...
                        new
                        {
                            Id = new Guid("beb8134b-b999-4850-95cb-6cf806f9769d"),
                        ...
                        new
                        {
                            Id = new Guid("356b2b5b-5550-4ddb-9443-b127b4506210"),
            ...
            modelBuilder.Entity("MyPortalAgency_API.Models.PageViewModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("605074af-a602-4afc-8e4d-a091cdf77ff9"),
                        ...
                        new
                        {
                            Id = new Guid("ba9ffc21-8790-4fa5-927d-0e789ac0870c"),
